...
const TypoSection: FC = () => {
  ...
  return (
    <TypoWrapper  ref={(el) => (targetRefs.current[0] = el as HTMLDivElement)} id="main-visual" className={entries["main-visual"] ? "scrolled" : ""} >
      <TypoImage src={TypoSvg} alt="타이포 이미지"  className={entries["main-visual"] ? "scrolled" : ""}/>
      ...
      <TypoBackgroundWrapper className={entries["main-visual"] ? "scrolled" : ""}>
