...
import { SynopsysTitle, SynopsysWrapper, SynopsysParagraph, SynopsysText, SynopsysTitleWrapper, SynopsysTitleBackground } from "@styles/main/synopsys-section.style";
...
const SynopsysSection: FC = () => {
    ...
    return (
        <SynopsysWrapper $image={SynopsysImage} $opacity={OPACITY}  ref={(el) => (targetRefs.current[0] = el as HTMLDivElement)} id="synopsys"  className={entries["synopsys"] ? "scrolled" : ""}>
            <SectionTitle
                text={{
                    title: "Synopsys",
                    subTitle: "About",
            ...
            <SynopsysTitleWrapper className={entries["synopsys"] ? "scrolled" : ""}>
                <SynopsysTitle className="non-mobile">낙천한 신들의 아이돌 도전기!</SynopsysTitle>
